...
export function AnimatedItem({
  ...
  return (
    <div
      ...
      style={{
        opacity: 0,
        animation: `hud-screen-in 0.45s cubic-bezier(0.2, 0.8, 0.2, 1) ${index * 0.1 + 0.1}s both`,
      }}
    >
      {children}
    </div>
...
export function HudHeader({ title }: { title: string }) {
  return (
    <header
      ...
      style={{
        paddingTop: "0.6rem",
        /* Status strip вище вже зайняв safe-area-inset-top */
...
export function ScreenShell({
  ...
  return (
    <div className="flex w-full flex-col overflow-hidden" style={{ height: "100dvh", paddingTop: "calc(max(1.25rem, env(safe-area-inset-top)) + 0.5rem)" }}>
