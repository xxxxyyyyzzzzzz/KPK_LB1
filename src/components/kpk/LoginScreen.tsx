...
function ErrorMessage({ err }: { err: string }) {
  return (
    <div
      className={`overflow-hidden transition-opacity duration-150 ease-out ${err ? "mt-2 max-h-24 opacity-100" : "max-h-0 opacity-0"}`}
    >
      {err ? (
      ...
      <div className="w-full max-w-md sm:max-w-[560px] lg:max-w-[620px]">
        ...
        >
          ...
          <div className="relative">
            {/* === MENU === */}
            <div className={`transition-opacity duration-150 ease-out ${panelClassName("menu")}`}>
            ...
            {/* === JOIN STEP 1: CODE === */}
            <div className={`transition-opacity duration-150 ease-out ${panelClassName("join_code")}`}>
            ...
            <div className={`transition-opacity duration-150 ease-out ${panelClassName("join_player")}`}>
